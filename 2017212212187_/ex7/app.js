...
//helper 项目显示
Handlebars.registerHelper('showProducts', function (entries, pageSize, pageNumber,options) {
  var str = "";
  str += "<tr>";
...
//Helper 分页
Handlebars.registerHelper('showPagination', function (pageNo, pageCount, options) {
  var str = ""
